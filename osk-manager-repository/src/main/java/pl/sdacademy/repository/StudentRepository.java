...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    List<Student> findStudentBySingleParam(@Param("firstName") String firstName, @Param("lastName") String lastName);


    @Query("SELECT s FROM Student s WHERE s.firstName = :firstName AND s.lastName = :lastName")
    List<Student> findStudentByAllParams(@Param("firstName") String firstName, @Param("lastName") String lastName);
}
