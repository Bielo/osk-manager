...
UPDATE `osk`.`student` SET `LATEST_VERSION`='0' WHERE `STUDENT_ID`='1';
UPDATE `osk`.`student` SET `LATEST_VERSION`='0' WHERE `STUDENT_ID`='2';

UPDATE `osk`.`teacher` SET `LATEST_VERSION`='0' WHERE `TEACHER_ID`='1';
UPDATE `osk`.`teacher` SET `LATEST_VERSION`='0' WHERE `TEACHER_ID`='2';